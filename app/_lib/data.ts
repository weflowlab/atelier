...
// ── 서비스 지역 (FAQ '어느 지역까지 방문 가능한가요?' · 푸터와 동일) — SEO 메타 키워드 / JSON-LD areaServed 용 ──
export const SERVICE_AREAS = ["서울", "경기", "인천", "춘천", "화천", "남양주"];

// ── 유입 키워드 매칭용 지역명 (파워링크 n_keyword / ?kw=) ──
// 페이지가 안내하는 서비스 지역 전체 + 본사(남양주) 동네 단위. 시·구 접미사 없이 적어 "강남커튼"처럼 붙여 쓴 키워드도 잡는다.
// 매칭은 긴 이름 우선(keywords.ts) — "남양주"가 "양주"보다, "강서"가 "서구"보다 먼저 잡힌다.
export const REGION_NAMES = [
  // 광역
  "서울", "경기", "인천", "강원",
  // 서울 25개 자치구 (중구는 한 글자 '중'으로 줄이면 오매칭되므로 그대로)
  "강남", "강동", "강북", "강서", "관악", "광진", "구로", "금천", "노원", "도봉", "동대문", "동작", "마포",
  "서대문", "서초", "성동", "성북", "송파", "양천", "영등포", "용산", "은평", "종로", "중구", "중랑",
  // 경기 31개 시·군
  "수원", "성남", "고양", "용인", "부천", "안산", "안양", "남양주", "화성", "평택", "의정부", "시흥", "파주", "광명",
  "김포", "광주", "군포", "하남", "오산", "이천", "안성", "의왕", "양주", "포천", "여주", "동두천", "과천", "구리",
  "양평", "가평", "연천",
  // 인천 (중구·동구·서구는 '인천'으로 잡힘)
  "미추홀", "연수", "남동구", "부평", "계양", "강화", "옹진",
  // 강원 일부
  "춘천", "화천",
  // 남양주 동네 단위 (본사 인근 파워링크 키워드)
  "다산", "별내", "마석", "화도", "호평", "평내", "진접", "오남", "퇴계원", "와부", "덕소", "금곡", "도농",
];

// ── 상품 키워드 (페이지의 제품 카드·시공 사례에 실제로 나오는 제품명) ──
// 긴 이름 우선 매칭(keywords.ts). 줄임말·별칭("허니콤", "콤비", "생활암막" 등)은 keywords.ts 의 PRODUCT_ALIASES 에서 정식 명칭으로 바꾼다.
export const PRODUCT_KEYWORDS = [
  "커튼", "암막커튼", "생활암막커튼", "쉬폰커튼", "속커튼", "린넨커튼", "방염커튼", "전동커튼", "로만쉐이드", "패널커튼", "유니슬렛커튼",
  "블라인드", "트리플쉐이드", "콤비블라인드", "허니콤블라인드", "우드블라인드", "한옥쉐이드", "알루미늄블라인드", "롤스크린", "썬스크린",
];
