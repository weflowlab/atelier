"use client";
// 방문 추적 — 관리자 '유입 관리' 탭 집계용. 방문 기록 + 이탈 시 체류시간·스크롤 도달률 전송.
...
function trackingDisabled(): boolean {
  ...
  return localStorage.getItem("atl_notrack") === "1";
}
...
export default function PageTracker() {
  ...
  useEffect(() => {
    ...
    if (params.get("notrack") === "1") localStorage.setItem("atl_notrack", "1");
    if (params.get("track") === "1") localStorage.removeItem("atl_notrack");
